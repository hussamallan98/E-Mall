				...
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<span class="user-icon">
							<?php echo "<img src='img/{$row['admin_image']}' alt=''>";?>
						</span>
				...
				<ul id="accordion-menu ">
					<li class="dropdown">
						<a href="manage-admin.php" class="dropdown-toggle">
							<span class="micon dw dw-copy"></span><span class="mtext">manage admin</span>
						</a>
						
					</li>
					<li class="dropdown">
						<a href="manage-customer.php" class="dropdown-toggle">
							<span class="micon dw dw-copy"></span><span class="">manage Customer</span>
						</a>
					</li>
					<li class="dropdown">
						<a href="manage-vendor.php" class="dropdown-toggle">
							<span class="micon dw dw-copy"></span><span class="mtext">manage Vendor</span>
						</a>
					</li>
					<li class="dropdown">
					...
					<li class="dropdown">
						<a href="manage-product.php" class="dropdown-toggle">
							<span class="micon dw dw-copy"></span><span class="mtext">manage Product</span>
						</a>
					</li>	
