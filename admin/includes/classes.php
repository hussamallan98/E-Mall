...
$query="SELECT * FROM customer where cust_email='$this->cust_email'";
    ...
    //header('location:..\student/login.php');
		$query = "INSERT INTO student(student_name,student_email,student_password,
									  student_edu,student_mobile,student_image)
				 VALUES('$this->stu_name','$this->stu_email','$this->stu_password',
				 		'$this->stu_edu','$this->stu_mobile','$this->stu_image')";
		$this->performQuery($query);
...
public function readAll(){
	...
	public function update($id)
	{
		...
		$query = "UPDATE vendor SET cust_name    ='$this->v_name',
								   v_email     ='$this->v_email',
								   v_password='$this->v_password',
								   v_address     ='$this->v_address',
								   v_mobile  ='$this->v_mobile',
...
class product extends dbconnection
{
	...
	public function create(){
		$query = "INSERT INTO product(pro_name,pro_desc,pro_price,pro_image,cat_id)
				 VALUES('$this->pro_name','$this->pro_desc','$this->pro_price',
				 '$this->pro_image','$this->cat_id')";
		$this->performQuery($query);
	}
	public function readAll(){
